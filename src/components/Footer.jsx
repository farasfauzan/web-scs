...
const Footer = () => {
  return (
    <footer className="bg-slate-200 dark:bg-[#0f172a] pt-20 pb-10 border-t border-slate-300 dark:border-slate-800 transition-colors duration-700">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col text-slate-900 dark:text-white transition-colors duration-700">
                ...
                <span className="text-[7px] font-bold uppercase tracking-widest mt-0.5 text-slate-500 dark:text-slate-400">Sinar Cerah Sempurna</span>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              {[<Facebook size={20} />, <Twitter size={20} />, <Instagram size={20} />, <Linkedin size={20} />].map((icon, i) => (
                <a key={i} href="#" className="interactive w-10 h-10 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-full flex items-center justify-center text-slate-600 dark:text-slate-400 hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900 transition-colors">
                  {icon}
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-600 dark:text-slate-400 text-sm transition-colors duration-700">
              {[
                ...
                <li key={i}>
                  <button
                    ...
                    className="interactive hover:text-orange-600 dark:hover:text-orange-500 transition-colors text-left"
                  >
                    {link.name}
                  </button>
                </li>
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm mb-4 transition-colors duration-700">Dapatkan kabar terbaru dan insight industri langsung ke email Anda.</p>
            <form className="flex" onSubmit={(e) => { e.preventDefault(); alert('Berhasil berlangganan!'); }}>
              <input type="email" placeholder="Email Anda" className="bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white px-4 py-3 rounded-l-lg w-full focus:outline-none focus:border-slate-900 dark:focus:border-white transition-colors duration-700" required />
        ...
        {/* Copyright Section */}
        <div className="border-t border-slate-300 dark:border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500 dark:text-slate-400">
